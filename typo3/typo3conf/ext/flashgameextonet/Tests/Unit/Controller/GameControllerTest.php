<?php
namespace FlashGameExtOneT\Flashgameextonet\Tests\Unit\Controller;
...
{
    /**
     * @var \FlashGameExtOneT\Flashgameextonet\Controller\GameController
     */
    ...
    {
        parent::setUp();
        $this->subject = $this->getMockBuilder(\FlashGameExtOneT\Flashgameextonet\Controller\GameController::class)
    ...
    public function listActionFetchesAllGamesFromRepositoryAndAssignsThemToView()
    {
        ...
        $gameRepository = $this->getMockBuilder(\FlashGameExtOneT\Flashgameextonet\Domain\Repository\GameRepository::class)
            ->setMethods(['findAll'])
            ->disableOriginalConstructor()
            ->getMock();
    ...
    {
        $game = new \FlashGameExtOneT\Flashgameextonet\Domain\Model\Game();
