...
class BuilderModule_action_domainmodelling_aeafb3a34b853d7018609b5f8580627aba46496f extends \TYPO3Fluid\Fluid\Core\Compiler\AbstractCompiledTemplate {
...
$output0 .= htmlspecialchars(EBT\ExtensionBuilder\ViewHelpers\Be\ConfigurationViewHelper::renderStatic($arguments1, $renderChildrenClosure2, $renderingContext), ENT_QUOTES);
...
$output3 .= htmlspecialchars(TYPO3Fluid\Fluid\ViewHelpers\LayoutViewHelper::renderStatic($arguments4, $renderChildrenClosure5, $renderingContext), ENT_QUOTES);
...
$output8 .= htmlspecialchars(EBT\ExtensionBuilder\ViewHelpers\Be\ConfigurationViewHelper::renderStatic($arguments9, $renderChildrenClosure10, $renderingContext), ENT_QUOTES);
