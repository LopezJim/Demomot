...
class Language_action_listLanguages_ac96522134d5313c4fb6b0b536ffbbac22ea8038 extends \TYPO3Fluid\Fluid\Core\Compiler\AbstractCompiledTemplate {
...
$output23 .= htmlspecialchars($renderingContext->getVariableProvider()->getByPath('language.locale', $array41), ENT_QUOTES);

$output23 .= '" data-language="';
$array42 = array (
);
$output23 .= htmlspecialchars($renderingContext->getVariableProvider()->getByPath('language.label', $array42), ENT_QUOTES);
...
$output23 .= htmlspecialchars(TYPO3\CMS\Fluid\ViewHelpers\TranslateViewHelper::renderStatic($arguments48, $renderChildrenClosure49, $renderingContext), ENT_QUOTES);
...
$output23 .= htmlspecialchars($renderingContext->getVariableProvider()->getByPath('language.locale', $array50), ENT_QUOTES);

$output23 .= '" data-language="';
$array51 = array (
);
$output23 .= htmlspecialchars($renderingContext->getVariableProvider()->getByPath('language.label', $array51), ENT_QUOTES);
...
$output23 .= htmlspecialchars(TYPO3\CMS\Fluid\ViewHelpers\TranslateViewHelper::renderStatic($arguments57, $renderChildrenClosure58, $renderingContext), ENT_QUOTES);
...
$output23 .= htmlspecialchars($renderingContext->getVariableProvider()->getByPath('language.label', $array59), ENT_QUOTES);

$output23 .= '</td>
				<td>';
$array60 = array (
);
$output23 .= htmlspecialchars($renderingContext->getVariableProvider()->getByPath('language.locale', $array60), ENT_QUOTES);
...
$output23 .= htmlspecialchars(TYPO3\CMS\Fluid\ViewHelpers\Format\DateViewHelper::renderStatic($arguments61, $renderChildrenClosure62, $renderingContext), ENT_QUOTES);
...
$output23 .= htmlspecialchars($renderingContext->getVariableProvider()->getByPath('language.locale', $array64), ENT_QUOTES);

$output23 .= '" data-language="';
$array65 = array (
);
$output23 .= htmlspecialchars($renderingContext->getVariableProvider()->getByPath('language.label', $array65), ENT_QUOTES);
...
$output23 .= htmlspecialchars($renderingContext->getVariableProvider()->getByPath('language.locale', $array66), ENT_QUOTES);

$output23 .= '" data-language="';
$array67 = array (
);
$output23 .= htmlspecialchars($renderingContext->getVariableProvider()->getByPath('language.label', $array67), ENT_QUOTES);
...
$output68 .= htmlspecialchars(TYPO3Fluid\Fluid\ViewHelpers\LayoutViewHelper::renderStatic($arguments69, $renderChildrenClosure70, $renderingContext), ENT_QUOTES);
...
$output73 .= htmlspecialchars(TYPO3\CMS\Fluid\ViewHelpers\TranslateViewHelper::renderStatic($arguments81, $renderChildrenClosure82, $renderingContext), ENT_QUOTES);
...
$output73 .= htmlspecialchars(TYPO3\CMS\Fluid\ViewHelpers\TranslateViewHelper::renderStatic($arguments83, $renderChildrenClosure84, $renderingContext), ENT_QUOTES);
...
$output73 .= htmlspecialchars(TYPO3\CMS\Fluid\ViewHelpers\TranslateViewHelper::renderStatic($arguments85, $renderChildrenClosure86, $renderingContext), ENT_QUOTES);
...
$output73 .= htmlspecialchars(TYPO3\CMS\Fluid\ViewHelpers\TranslateViewHelper::renderStatic($arguments87, $renderChildrenClosure88, $renderingContext), ENT_QUOTES);
...
$output73 .= htmlspecialchars(TYPO3\CMS\Fluid\ViewHelpers\TranslateViewHelper::renderStatic($arguments89, $renderChildrenClosure90, $renderingContext), ENT_QUOTES);
...
$output73 .= htmlspecialchars(TYPO3\CMS\Fluid\ViewHelpers\TranslateViewHelper::renderStatic($arguments91, $renderChildrenClosure92, $renderingContext), ENT_QUOTES);
...
$output96 .= htmlspecialchars($renderingContext->getVariableProvider()->getByPath('language.locale', $array97), ENT_QUOTES);

$output96 .= '" data-locale="';
$array98 = array (
);
$output96 .= htmlspecialchars($renderingContext->getVariableProvider()->getByPath('language.locale', $array98), ENT_QUOTES);
...
$output96 .= htmlspecialchars($renderingContext->getVariableProvider()->getByPath('language.locale', $array114), ENT_QUOTES);

$output96 .= '" data-language="';
$array115 = array (
);
$output96 .= htmlspecialchars($renderingContext->getVariableProvider()->getByPath('language.label', $array115), ENT_QUOTES);
...
$output96 .= htmlspecialchars(TYPO3\CMS\Fluid\ViewHelpers\TranslateViewHelper::renderStatic($arguments121, $renderChildrenClosure122, $renderingContext), ENT_QUOTES);
...
$output96 .= htmlspecialchars($renderingContext->getVariableProvider()->getByPath('language.locale', $array123), ENT_QUOTES);

$output96 .= '" data-language="';
$array124 = array (
);
$output96 .= htmlspecialchars($renderingContext->getVariableProvider()->getByPath('language.label', $array124), ENT_QUOTES);
...
$output96 .= htmlspecialchars(TYPO3\CMS\Fluid\ViewHelpers\TranslateViewHelper::renderStatic($arguments130, $renderChildrenClosure131, $renderingContext), ENT_QUOTES);
...
$output96 .= htmlspecialchars($renderingContext->getVariableProvider()->getByPath('language.label', $array132), ENT_QUOTES);

$output96 .= '</td>
				<td>';
$array133 = array (
);
$output96 .= htmlspecialchars($renderingContext->getVariableProvider()->getByPath('language.locale', $array133), ENT_QUOTES);
...
$output96 .= htmlspecialchars(TYPO3\CMS\Fluid\ViewHelpers\Format\DateViewHelper::renderStatic($arguments134, $renderChildrenClosure135, $renderingContext), ENT_QUOTES);
...
$output96 .= htmlspecialchars($renderingContext->getVariableProvider()->getByPath('language.locale', $array137), ENT_QUOTES);

$output96 .= '" data-language="';
$array138 = array (
);
$output96 .= htmlspecialchars($renderingContext->getVariableProvider()->getByPath('language.label', $array138), ENT_QUOTES);
...
$output96 .= htmlspecialchars($renderingContext->getVariableProvider()->getByPath('language.locale', $array139), ENT_QUOTES);

$output96 .= '" data-language="';
$array140 = array (
);
$output96 .= htmlspecialchars($renderingContext->getVariableProvider()->getByPath('language.label', $array140), ENT_QUOTES);
