...
class FileList_action_index_c25f32ca8e95b7553e91909e0e20680710bd76b6 extends \TYPO3Fluid\Fluid\Core\Compiler\AbstractCompiledTemplate {
...
$output0 .= htmlspecialchars($renderingContext->getVariableProvider()->getByPath('headline', $array1), ENT_QUOTES);
...
$output23 .= htmlspecialchars($renderingContext->getVariableProvider()->getByPath('checkboxes.bigControlPanel.label', $array27), ENT_QUOTES);
...
$output33 .= htmlspecialchars($renderingContext->getVariableProvider()->getByPath('checkboxes.displayThumbs.label', $array37), ENT_QUOTES);
...
$output43 .= htmlspecialchars($renderingContext->getVariableProvider()->getByPath('checkboxes.enableClipBoard.label', $array47), ENT_QUOTES);
...
$output64 .= htmlspecialchars($renderingContext->getVariableProvider()->getByPath('headline', $array65), ENT_QUOTES);
...
$output89 .= htmlspecialchars($renderingContext->getVariableProvider()->getByPath('checkboxes.bigControlPanel.label', $array93), ENT_QUOTES);
...
$output99 .= htmlspecialchars($renderingContext->getVariableProvider()->getByPath('checkboxes.displayThumbs.label', $array103), ENT_QUOTES);
...
$output109 .= htmlspecialchars($renderingContext->getVariableProvider()->getByPath('checkboxes.enableClipBoard.label', $array113), ENT_QUOTES);
