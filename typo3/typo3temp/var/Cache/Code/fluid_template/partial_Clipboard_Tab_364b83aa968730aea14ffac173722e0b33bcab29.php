...
class partial_Clipboard_Tab_364b83aa968730aea14ffac173722e0b33bcab29 extends \TYPO3Fluid\Fluid\Core\Compiler\AbstractCompiledTemplate {
...
$output0 .= htmlspecialchars($renderingContext->getVariableProvider()->getByPath('tab.url', $array1), ENT_QUOTES);
...
$output4 .= htmlspecialchars($renderingContext->getVariableProvider()->getByPath('tab.description', $array5), ENT_QUOTES);
...
$output45 .= htmlspecialchars(TYPO3Fluid\Fluid\ViewHelpers\Format\PrintfViewHelper::renderStatic($arguments46, $renderChildrenClosure47, $renderingContext), ENT_QUOTES);

$output45 .= '
				';
$array59 = array (
);
$output45 .= htmlspecialchars($renderingContext->getVariableProvider()->getByPath('tab.padding', $array59), ENT_QUOTES);
...
$output62 .= htmlspecialchars(TYPO3Fluid\Fluid\ViewHelpers\Format\PrintfViewHelper::renderStatic($arguments63, $renderChildrenClosure64, $renderingContext), ENT_QUOTES);
$array76 = array (
);
$output62 .= htmlspecialchars($renderingContext->getVariableProvider()->getByPath('tab.padding', $array76), ENT_QUOTES);
...
$output8 .= htmlspecialchars(TYPO3Fluid\Fluid\ViewHelpers\Format\PrintfViewHelper::renderStatic($arguments9, $renderChildrenClosure10, $renderingContext), ENT_QUOTES);

$output8 .= '
				';
$array22 = array (
);
$output8 .= htmlspecialchars($renderingContext->getVariableProvider()->getByPath('tab.padding', $array22), ENT_QUOTES);
...
$output23 .= htmlspecialchars(TYPO3Fluid\Fluid\ViewHelpers\Format\PrintfViewHelper::renderStatic($arguments24, $renderChildrenClosure25, $renderingContext), ENT_QUOTES);
$array37 = array (
);
$output23 .= htmlspecialchars($renderingContext->getVariableProvider()->getByPath('tab.padding', $array37), ENT_QUOTES);
