...
class Standard_action_index_c4393a60fd7355f9f2f1e55cdb9324de68263006 extends \TYPO3Fluid\Fluid\Core\Compiler\AbstractCompiledTemplate {
...
$output38 .= htmlspecialchars($renderingContext->getVariableProvider()->getByPath('subModule.description', $array44), ENT_QUOTES);

$output38 .= '" href="';
$array45 = array (
);
$output38 .= htmlspecialchars($renderingContext->getVariableProvider()->getByPath('subModule.link', $array45), ENT_QUOTES);

$output38 .= '" class="modulemenu-item-link">
