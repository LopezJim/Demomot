...
{
    /**
     * @var \FlashGameExt\Flashgameext\Controller\UserController
     */
    ...
    {
        parent::setUp();
        $this->subject = $this->getMockBuilder(\FlashGameExt\Flashgameext\Controller\UserController::class)
    ...
    public function listActionFetchesAllUsersFromRepositoryAndAssignsThemToView()
    {
        ...
        $userRepository = $this->getMockBuilder(\FlashGameExt\Flashgameext\Domain\Repository\UserRepository::class)
            ->setMethods(['findAll'])
            ->disableOriginalConstructor()
            ->getMock();
    ...
    {
        $user = new \FlashGameExt\Flashgameext\Domain\Model\User();
