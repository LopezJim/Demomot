...
return [
    'ctrl' => [
        ...
        'searchFields' => 'gam_path,gam_name,use_uploader',
        'iconfile' => 'EXT:flashgameextonet/Resources/Public/Icons/tx_flashgameextonet_domain_model_game.gif'
    ],
    'interface' => [
        'showRecordFieldList' => 'sys_language_uid, l10n_parent, l10n_diffsource, hidden, gam_path, gam_name, use_uploader',
    ],
    'types' => [
        '1' => ['showitem' => 'sys_language_uid, l10n_parent, l10n_diffsource, hidden, gam_path, gam_name, use_uploader, --div--;LLL:EXT:frontend/Resources/Private/Language/locallang_ttc.xlf:tabs.access, starttime, endtime'],
    ],
    'columns' => [
        'sys_language_uid' => [
            'exclude' => true,
        ...
        'use_uploader' => [
            'exclude' => false,
            'label' => 'LLL:EXT:flashgameextonet/Resources/Private/Language/locallang_db.xlf:tx_flashgameextonet_domain_model_game.use_uploader',
            'config' => [
                'type' => 'input',
                'size' => 30,
                'eval' => 'trim,required'
