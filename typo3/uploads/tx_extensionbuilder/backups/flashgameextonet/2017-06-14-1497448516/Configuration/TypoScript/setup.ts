...
plugin.tx_flashgameextonet_frontendflashgameonet {
    view {
        ...
        templateRootPaths.1 = {$plugin.tx_flashgameextonet_frontendflashgameonet.view.templateRootPath}
        partialRootPaths.0 = EXT:flashgameextonet/Resources/Private/Partials/
        partialRootPaths.1 = {$plugin.tx_flashgameextonet_frontendflashgameonet.view.partialRootPath}
        layoutRootPaths.0 = EXT:flashgameextonet/Resources/Private/Layouts/
        layoutRootPaths.1 = {$plugin.tx_flashgameextonet_frontendflashgameonet.view.layoutRootPath}
    }
    persistence {
        storagePid = {$plugin.tx_flashgameextonet_frontendflashgameonet.persistence.storagePid}
        #recursive = 1
    }
    features {
